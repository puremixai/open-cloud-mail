const zh = {
    ...
    win95ExitConfirm: '确定要退出 Windows 95 模式，返回现代界面吗？',
    win95Min: '最小化',
    win95Max: '最大化',
    win95Restore: '还原',
    win95Close: '关闭',
    win95SwitchTheme: '切换主题',
    win95Homepage: '主站',
    win95UnderConstruction: '正在建设中',
    win95Start: '开始',
    win95RecycleBin: '回收站',
    win95BinEmpty: '回收站是空的。',
    win95Logout: '注销...',
    win95LogoutConfirm: '您确定要注销当前用户吗？',
    win95Shutdown: '关闭系统...',
    win95ShutdownConfirm: '您确定要关闭计算机吗？',
    ...
    win95IdcardEmailLabel: '邮箱地址',
    win95IdcardShowFront: '查看正面',
    win95IdcardShowBack: '查看背面',
    win95IdcardCopyEmail: '点击复制邮箱',
    win95IdcardFullEmail: '完整邮箱地址',
    win95IdcardCopyFailed: '复制失败，可在上方选中地址手动复制。',
    win95IdcardSelectEmail: '可选中地址手动复制',
    win95IdcardValidThru: 'VALID THRU',
    win95IdcardWish: '祝你开心每一天！',
    win95IdcardStyle: '切换卡片样式',
    win95StudentCard: '学生证',
    idcardTitle: '学生证',
    idcardSub: '一人一证 · 仅限本人使用',
    idcardSchool: 'PureMail 学院',
    idcardEnglish: 'STUDENT IDENTITY CERTIFICATE',
    idcardRibbon: '学生证',
    idcardFlip: '翻面',
    idcardFlipHint: '点击证件可翻面',
    idcardPrint: '打印证件',
    idcardCopyNo: '复制学号',
    idcardCopyEmail: '复制邮箱',
    idcardCopiedNo: '已复制学号',
    idcardDossier: '证件档案',
    idcardFieldName: '姓名',
    idcardFieldNo: '学号',
    idcardFieldDept: '院系',
    ...
    idcardFieldStatus: '学籍状态',
    idcardActive: '在籍',
    idcardGraduated: '已毕业（永久校友）',
    idcardGraduatedStamp: '荣誉毕业',
    idcardMotto: '好好学习，天天向上',
    idcardSealText: '证件专用章',
    idcardNotesTitle: '使用说明',
    idcardNote1: '本证由系统自动签发，仅作为站点身份的趣味展示。',
    idcardNote2: '校园邮箱是收发邮件的唯一凭证，请妥善保管。',
    idcardNote3: '学号即用户 ID，联系管理员时提供学号可快速定位账号。',
    idcardNote4: '注销账号后，本证自动作废。',
    idcardRegTitle: '注册记录',
    idcardLost: '本证仅限本人使用，如拾到请交还管理员。',
    idcardDisclaimer: '本证件为社区趣味身份展示，不具备法律效力。',
    newMail: '新邮件',
    menuFile: '文件',
    menuEdit: '编辑',
    menuView: '查看',
